    ...
    <nav className="bg-white border-b border-[var(--color-border-main)] sticky top-0 z-50">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-10 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/profile" className="flex items-center gap-2 px-4 py-2 bg-[var(--color-primary-600)] text-white rounded-full text-sm font-medium hover:bg-[var(--color-primary-800)] transition-colors">
            <User size={16} />
